...
async def start(event):
    ...
    await event.reply(
        ...
        buttons=[
            ...
            [
                Button.url("SOURCE CODE", url="https://github.com/tiktikimelbo7/compressorbot"),
                Button.url("DEVELOPER", url="t.me/tonmoy_spark"),
            ],
        ],
    )
...
ping_handler = CommandHandler(BotCommands.PingCommand, up, run_async=True)
